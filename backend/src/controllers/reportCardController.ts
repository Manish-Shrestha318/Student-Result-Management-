...
export const generateBulkReportCards = async (req: Request, res: Response) => {
  try {
...
export const emailReportCard = async (req: Request, res: Response) => {
  try {
...
export const previewReportCard = async (req: Request, res: Response) => {
  try {
    const studentId = req.query.studentId as string;
    const term = req.query.term as string;
    const yearStr = req.query.year as string;
